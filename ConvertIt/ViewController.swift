...
class ViewController: UIViewController {
    ...
    var formulaArray = ["miles to kilometers", "kilometers to miles", "feet to meters",
                        "yards to meters", "meters to feet", "meters to yards", "inches to cm", "cm to inches", "fahrenheit to celcius", "celcius to fahrenheit", "quarts to liter", "liters to quarts"]
